...
function Hero() {
  return (
    <div className="md:flex md:items-center md:justify-center bg-neutral-800 z-20">
      <div className="md:w-full md:h-full mx-auto">
        <div className="hidden md:flex [&:hover>div]:w-[18rem] [&>div:hover]:w-full">
          ...
          <div className="group relative shadow-lg shadow-black/30 md:h-[57rem] w-full cursor-pointer overflow-hidden transition-all duration-1000">
            ...
            <div className="absolute md:visible inset-0 bg-gradient-to-b from-black/40 via-black/70 to-black Z-50">
              <div className="absolute left-36 ml-50 min-w-0 p-6 top-96">
                <div className="gap-3 text-white w-auto pl-6 overflow-hidden">
                  <h1 className="font-semibold text-6xl text-gray-100 ">
                    DARE TO DREAM
                  </h1>
                  <h1 className="font-semibold text-6xl text-gray-100">
            ...
            <div className="absolute inset-0 flex overflow-x-hidden tracking-wide outline-title mix-blend-difference mt-28">
              <div className="py-12 animate-marquee whitespace-nowrap uppercase">
                <span className="mx-4 hover:text-white duration-150 decoration-8">
                  FAT OWL
                </span>
                <span className="mx-4 hover:text-white duration-150 decoration-8">
                  FAT OWL
            ...
            <div className="absolute bottom-4 inset-x-10">
              <span className="text-[#c0c0c0b7]">SCROLL DOWN</span>
              <ArrowLongDownIcon className="h-12 text-[#c0c0c0b7] w-6" />
            </div>
          </div>
        </div>
      </div>
